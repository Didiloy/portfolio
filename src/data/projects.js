...
const projects = [{
    ...
    },
    {
        ...
        projectInfo: {
            objectivesHeading: "Objective",
            objectivesDetails: "Have recommendations based on what you have already read ! https://vue-book-suggestion.netlify.app/",
            technologies: [{
                title: "Tools & Technologies",
    ...
    },
    {
        ...
        projectInfo: {
            ...
            projectDetails: [{
                id: 1,
                details: "I've built this web application with Vue Js as a school project with a classmate. It is with this project that I learned Vue Js and Materialize CSS. I use the IMDB Api to fetch the movies and Tvs shows informations. The application also use the locale storage to store movies or Tvs shows as favorite.",
            }, ],
        },
    },
    {
